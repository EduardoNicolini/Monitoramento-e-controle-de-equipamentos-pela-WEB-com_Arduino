            ...
            if(client.available()){
                ...
                if(c == '\n' && continua)
                {
                    ...
                    if(iniciofrente>-1){     //verifica se o comando veio
                        ...
                        if      ( acao == "001"){ digitalWrite(rele, LOW); } // Recebe o valor de ID do botão na pagina no servidor e retorna em JSON para tomar a ação 
                        
                        else if ( acao == "002"){ digitalWrite(rele, HIGH);} // Recebe o valor de ID do botão na pagina no servidor e retorna em JSON para tomar a ação 
